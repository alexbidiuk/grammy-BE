!function (e, a) {
  ...
  var U = /\d/, V = /\d\d/, K = /\d{3}/, Z = /\d{4}/, $ = /[+-]?\d{6}/, B = /\d\d?/, q = /\d\d\d\d?/,
  ...
  }), I(0, ['YYYY', 4], 0, 'year'), I(0, ['YYYYY', 5], 0, 'year'), I(0, ['YYYYYY', 6, !0], 0, 'year'), P('year', 'y'), A('year', 1), ie('Y', se), ie('YY', B, V), ie('YYYY', ee, Z), ie('YYYYY', ae, $), ie('YYYYYY', ae, $), le(['YYYYY', 'YYYYYY'], he), le('YYYY', function (e, a) {
  ...
  }), et('gggg', 'weekYear'), et('ggggg', 'weekYear'), et('GGGG', 'isoWeekYear'), et('GGGGG', 'isoWeekYear'), P('weekYear', 'gg'), P('isoWeekYear', 'GG'), A('weekYear', 1), A('isoWeekYear', 1), ie('G', se), ie('g', se), ie('GG', B, V), ie('gg', B, V), ie('GGGG', ee, Z), ie('gggg', ee, Z), ie('GGGGG', ae, $), ie('ggggg', ae, $), Me(['gggg', 'ggggg', 'GGGG', 'GGGGG'], function (e, a, t, s) {
    a[s.substr(0, 2)] = g(e)
  ...
  mt.calendar = function (e, a, t) {
    ...
    return this._weekdaysParseExact ? (h(this, '_weekdaysRegex') || Be.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (h(this, '_weekdaysShortRegex') || (this._weekdaysShortRegex = Ze), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
  }, mt.weekdaysMinRegex = function (e) {
    return this._weekdaysParseExact ? (h(this, '_weekdaysRegex') || Be.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (h(this, '_weekdaysMinRegex') || (this._weekdaysMinRegex = $e), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex)
  }, mt.isPM = function (e) {
  ...
  Rt.isValid = function () {
    ...
    t._d = new Date(g(e))
  }), l.version = '2.22.1', e = Sa, l.fn = it, l.min = function () {
